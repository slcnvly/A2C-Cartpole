...
REINFORCE: Required ~2000 episodes to reach stable performance.

A2C: Achieved similar performance in just ~600 episodes (3x Faster Convergence).

This demonstrates that the Critic's baseline effectively stabilizes the direction of learning, allowing the agent to learn much faster with fewer samples.
